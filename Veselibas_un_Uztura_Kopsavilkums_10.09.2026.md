...
| **10.09. (Ceturtd.)**| **2 907** | **3 915** | **-1 008 kcal** 🔥 | **222.2** | **63.9** | **14.33 km** | Spēks B (1h 10m) | 85 / 7.0h | 49 | **81.53 kg** *(11.09 rīts)* | **25.2%** | **32.24 kg** | **+0.25 kg** *(glikogēns/muskuļi)* |
...
```mermaid
graph LR
    A["Kopējais deficīts: -2 955 kcal"] --> B["Svara samazinājums: -0.76 kg"]
    B --> C["Tauku %: 25.6% ➔ 25.1-25.2%"]
    C --> D["Fitness Age: 40.9 gadi"]
    D --> E["Muskuļu masa 100% saglabāta (~32.24 kg)"]
```
